...
<ww:form name="rentForm" action="saveRent" method="POST" enctype="multipart/form-data">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="rent.screen"/></td>
        <td class="cInputColumn">
            <ww:textfield name="rent.screen" value="%{rent.screen}" maxlength="0" cssClass="cInputTextField" />
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="rent.fmYear"/></td>
        <td class="cInputColumn">
            <ww:textfield name="rent.fmYear" value="%{rent.fmYear}" maxlength="0" cssClass="cInputTextField" />
        </td>
    </tr>
    ...
    <tr><td class="cInputCaption"><fmt:message key="rent.assign"/></td>
        <td class="cInputColumn">
            <ww:checkbox name="rent.assign" cssClass="cCheckboxField" />
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="rent.memo"/></td>
        <td class="cInputColumn">
            <ww:textfield name="rent.memo" value="%{rent.memo}" maxlength="0" cssClass="cInputTextField" />
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="rent.isEdited"/></td>
        <td class="cInputColumn">
            <ww:checkbox name="rent.isEdited" cssClass="cCheckboxField" />
        </td>
    </tr>
    ...
    <tr><td class="cInputCaption"><fmt:message key="rent.vendor"/></td>
        <td class="cInputColumn">
    ...
    <tr><td class="cInputCaption"><fmt:message key="rent.kind"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:select name="rent.kindId" 
               headerKey=""
               headerValue="%{getText('common.pleaseSelect')}..."
               list="kindList"
               listKey="id"
               listValue="caption_"
               cssClass="cInputListField"
            /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('rent.kindId')"/></span>
        </td>
    </tr>
