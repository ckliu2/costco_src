...
public class Rent extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public Rent(Integer year, Boolean isUpToDate, String screen, String fmYear, Date lastModifiedDate, Date createdDate, Boolean assign, String memo, com.costco.value.Billboard billboard, com.costco.value.Vendor vendor, UploadedFile photo, UploadedFile cover, AppProperty kind, Member lastModifiedUser, Member createdUser) {
        this.year = year;
    ...
    /** minimal constructor */
    public Rent(Integer year, com.costco.value.Billboard billboard, com.costco.value.Vendor vendor, AppProperty kind, Member createdUser) {
        this.year = year;
        this.billboard = billboard;
        this.vendor = vendor;
        this.kind = kind;
