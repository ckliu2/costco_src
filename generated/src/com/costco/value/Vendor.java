...
public class Vendor extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public Vendor(String name, String address, String contact, String title, String phone, Date lastModifiedDate, Date createdDate, String no, String deptNo, String product1, String product2, String product3, String product4, String product5) {
        this.name = name;
