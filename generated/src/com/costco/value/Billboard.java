...
public class Billboard extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public Billboard(String costcoId, Integer no, Float width, Float height, AppProperty size, UploadedFile cover, com.costco.value.Store store, UploadedFile location1, UploadedFile location2, UploadedFile location3) {
