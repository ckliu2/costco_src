...
public class Rent extends BaseObject implements Serializable {
	...
	public String toString() {
		return new ToStringBuilder(this).append("year", getYear()).append("isUpToDate", getIsUpToDate()).append("lastModifiedDate", getLastModifiedDate()).append("createdDate", getCreatedDate()).append("billboard", getBillboard()).append("vendor", getVendor()).append("cover", getCover()).append("lastModifiedUser", getLastModifiedUser()).append("createdUser", getCreatedUser()).toString();
	}
